  ...
  return (
    <div className="w-full max-w-sm space-y-6">
      <h1 className="text-2xl font-bold text-center">
        {mode === 'login' ? 'Sign in to Setplay' : 'Create your account'}
      </h1>
      ...
      <div className="space-y-3">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 border rounded px-3 py-2 text-sm font-medium hover:bg-gray-50"
        >
